...
<input type="submit" value="Add Investor" name="inv_add" class="btn btn-info">
...
<div class="add-admin">
     <a href="entro_add.php">inv</a></div>

     </div>
<?php 
   
   if(isset($_REQUEST['inv_add'])){
    header('location:investor_add.php;');
...
<br><br>
      ...
      if(isset($_REQUEST['delete_m_data'])){
        ...
        if($run_dq){ header('location:admin-investor.php;');
        }
        ...
        //    echo "<br>";
           ...
           ?>
                   ...
                   <tr>
                        ...
                        <!-- <td><?php //echo "$id"; ?></td> -->
                        <td><img width="50px"; src="../Home/en_profile/<?php echo $profile_pic;?>"></td>
                        <td><?php echo "$name"; ?></td>
                        <td><?php echo "$nid"; ?></td>

...
<?php 
   ...
   if(!empty($name)){
    ...
    $sqlin= "INSERT INTO `investor_reg_table1` (`profile_photo`, `name`, `username`, `nid`, `email`, `password`, `date_sign`) VALUES ('$name_changer', '$fullname', '$usnm', '$nid', '$eml', '$password', '$today')";

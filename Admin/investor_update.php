...
require "includes/configure.php";
  ...
  $sql= "UPDATE `investor_reg_table1` SET name='$nname',nid='$nnid',email='$nemail',username='$nusnm',password='$npassword' WHERE id = $rcv";
  $resultt=mysqli_query($connnection,$sql);

 if($resultt){
      header("location:admin-investor.php?Updated");
                         }else{
                   echo "not Updated";
                               }

...
<html>
    ...
    <head>
       <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <link rel="stylesheet" href="all_css/investor_first_style.css">
...
<div class="userdetails-in-profile sobclass">
    ...
    <a href="../Home/home.php">Sign Out</a>
</div>
                   ...
                   <div class="main_body_f">
                    <div class="container1">
                            ...
                            <div class="get-starts">
                                ...
                                <input onclick="location.href='investor-get-investment-page1.php'" type="submit" class="get-starts-button" value="get started">
